        ...
        <div class="content-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Thông tin đầu sách của <?=$tuasach['ten']?> (<?=$dausach['ngonngu']?>)</h3>
                </div>
                <?=form_open('', NULL, NULL)?>
                <div class="card-body">
                    <div class="form-group">
                        <label>Năm xuất bản <?=$required?></label>
                        <?=form_input($attributes['namxuatban'])?>
                        <?=form_error('namxuatban', '<div class="error text-danger">', '</div>')?>
                    </div>

                    <div class="form-group icheck">
                        <label>Tình trạng cuốn sách</label>
